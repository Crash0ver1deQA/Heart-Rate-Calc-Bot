...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if query.data == "restart":
        # Красиво убираем кнопку: редактируем сообщение, удаляя клавиатуру
        await query.edit_message_text(
            text="Расчёт перезапущен! 🔄\n\nВведите свой возраст (в годах):",
            reply_markup=None  # Здесь кнопка исчезает с анимацией Telegram
        )
        return AGE  # Переходим сразу к состоянию ввода возраста
