...
def calculate_zones(age: int, resting_hr: int):
    ...
    zone_1 = (round(resting_hr + (max_hr - resting_hr) * 0.5), round(resting_hr + (max_hr - resting_hr) * 0.6))
    zone_2 = (round(resting_hr + (max_hr - resting_hr) * 0.6), round(resting_hr + (max_hr - resting_hr) * 0.7))
    zone_3 = (round(resting_hr + (max_hr - resting_hr) * 0.7), round(resting_hr + (max_hr - resting_hr) * 0.8))
    zone_4 = (round(resting_hr + (max_hr - resting_hr) * 0.8), round(resting_hr + (max_hr - resting_hr) * 0.9))
...
async def get_resting_hr(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    try:
        ...
        response = (
            f'Максимальная ЧСС: {max_hr} уд./мин.\n'
